...
/**
 * FloodMap Component - Displays an interactive ArcGIS map
 * @param {Function} onLayerLoad - Callback when the feature layer loads
 * @param {Function} onViewLoad - Callback when the map view loads
 * @param {Function} onCountryClick - Callback when a country is clicked
